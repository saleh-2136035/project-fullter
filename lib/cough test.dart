...
class _CoughTestScreenState extends State<CoughTestScreen> {
  ...
  Future<void> _startRecording() async {
    ...
    await _audioRecorder.startRecorder(toFile: filePath, codec: Codec.pcm16WAV);
  ...
  Future<void> _analyzeAudio(String path) async {
    ...
    try {
      var request = MultipartRequest(
        'POST',
        Uri.parse(
          'https://smart-analysis-of-health-condition.onrender.com/api/analyze_audio/',
        ),
      );
      ...
      if (response.statusCode == 200) {
        ...
        bool isPositive =
            result.toLowerCase().startsWith("مصاب") ||
