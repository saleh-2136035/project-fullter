    ...
    try {
      ...
      if (refreshRes.statusCode == 200) {
        ...
        final res = await http.get(
          Uri.parse(
            'https://smart-analysis-of-health-condition.onrender.com/api/doctor_appintments/$doctorID/',
          ),
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (chatId != null) {
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'لا توجد دردشة متاحة لهذا الموعد حالياً.',
                                          ),
                                        ),
                                      );
                                    }
